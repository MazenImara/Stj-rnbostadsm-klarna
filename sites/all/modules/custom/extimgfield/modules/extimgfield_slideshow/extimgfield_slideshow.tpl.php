...
/**
 * @file
 * Template file for extimgfield_slideshow
 *
 *
 */
...
?>
<div id="extimgfield-slideshow-<?php print $slideshow_id; ?>-wrapper" class="extimgfield-slideshow-wrapper">
    ...
    <?php foreach ($items as $num => $item) : ?>
      <div class="<?php print $item['classes']; ?>"<?php if ($num) : ?> style="display:none;"<?php endif; ?>>
        ...
        <?php if (isset($item['caption']) && $item['caption'] != '') : ?>
          <div class="extimgfield-slideshow-caption">
            <span class="extimgfield-slideshow-caption-text"><?php print $item['caption']; ?></span>
          </div>
        <?php endif; ?>
      </div>
    <?php endforeach; ?>
