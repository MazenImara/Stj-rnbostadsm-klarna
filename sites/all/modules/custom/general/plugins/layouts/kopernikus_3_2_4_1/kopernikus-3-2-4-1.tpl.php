<div class="panel-display omega-grid kopernikus-3-2-4-1" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
  ...
  <div class="panel-panel grid-8 top top-middle">
  ...
  <div class="panel-panel grid-6 bottom bottom-2">
    <div class="inside"><?php print $content['bottom_2']; ?></div>
  </div>
  <div class="panel-panel grid-6 bottom bottom-3">
    <div class="inside"><?php print $content['bottom_3']; ?></div>
  </div>
