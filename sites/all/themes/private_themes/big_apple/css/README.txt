...
To use these stylesheets, rename the files and big_apple with the name of your theme.
...
big_apple-alpha-default-narrow.css  
...
big_apple-alpha-default-normal.css
...
big_apple-alpha-default-wide.css
