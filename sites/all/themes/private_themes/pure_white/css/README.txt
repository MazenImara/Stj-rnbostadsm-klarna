...
To use these stylesheets, rename the files and svartinge with the name of your theme.
...
svartinge-alpha-default-narrow.css  
...
svartinge-alpha-default-normal.css
...
svartinge-alpha-default-wide.css
