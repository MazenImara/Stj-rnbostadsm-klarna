...
To use these stylesheets, rename the files and waterfall with the name of your theme.
...
waterfall-alpha-default-narrow.css  
...
waterfall-alpha-default-normal.css
...
waterfall-alpha-default-wide.css
