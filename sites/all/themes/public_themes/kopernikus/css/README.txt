...
To use these stylesheets, rename the files and kopernikus with the name of your theme.
...
kopernikus-alpha-default-narrow.css  
...
kopernikus-alpha-default-normal.css
...
kopernikus-alpha-default-wide.css
